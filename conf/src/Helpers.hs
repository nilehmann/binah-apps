...
{-@ checkPcOr :: _ -> u:_ -> TaggedT<{\_ -> True}, {\v -> currentUser v}> _ _ {v: () | IsPc u} @-}
...
{-@ checkChairOr :: _ -> u:_ -> TaggedT<{\_ -> True}, {\v -> currentUser v}> _ _ {v: () | IsChair u} @-}
...
{-@ checkStageOr :: _ -> s:_  -> TaggedT<{\_ -> True}, {\v -> currentUser v}> _ _ {v: () | s == currentStage} @-}
